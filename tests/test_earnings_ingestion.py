...
from app.adapters.market.base import EarningsProvider, EarningsReportResult
from app.adapters.market.yfinance import earnings_reports_from_frames, period_from_end
...
class StaticEarningsProvider(EarningsProvider):
    def __init__(
        self, results: dict[str, list[EarningsReportResult] | Exception]
    ) -> None:
